                    ...
                    <tr>
                        ...
                        <td>
                            <div style="display:flex; align-items:center; gap:6px; flex-wrap:nowrap;">
                                {{-- Tombol Edit --}}
                                <a href="{{ route('karyawan.edit', $k->nik) }}" class="btn-edit" style="display:inline-flex;align-items:center;gap:5px;background:rgba(99,102,241,0.12);border:1px solid rgba(99,102,241,0.3);border-radius:6px;padding:5px 12px;font-size:11px;font-weight:500;color:#A5B4FC;text-decoration:none;transition:all 0.2s;">
                                    <svg width="12" height="12" fill="none" stroke="currentColor" viewBox="0 0 24 24" style="width:12px;height:12px;flex-shrink:0;">
                                ...
                                <form action="{{ route('karyawan.destroy', $k->nik) }}" method="POST"
                                    id="form-hapus-{{ $k->nik }}" style="margin:0;">
                                    @csrf
                                    @method('DELETE')
